function CompileCLibraries()
    % This function compiles the C/C++ files used with the Victoria Park 
    % data set If you have compilation issues, read the following carefully! 
    %
    ...
    mex('-R2018a','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','-outdir','./compiled_mex',...
        '-I../Shared Files/mex source/Victoria_Park_models/','../Shared Files/mex source/cost_matrix.c',...
        '../Shared Files/mex source/Victoria_Park_models/models.c');

    fprintf('compiling hypothesisReductionAlgorithm.c\n')
    mex('-R2018a','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','-outdir','./compiled_mex',...
        '-I../Shared Files/mex source/Victoria_Park_models/','../Shared Files/mex source/hypothesisReductionAlgorithm.c',...
        '../Shared Files/mex source/Victoria_Park_models/models.c');
    ...
    mex('-R2018a','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','-outdir','./compiled_mex',...
        '-I../Shared Files/mex source/Victoria_Park_models/','../Shared Files/mex source/mhrbiploid.c',...
        '../Shared Files/mex source/Victoria_Park_models/models.c');
    ...
    mex('-R2018a','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','-outdir','./compiled_mex',...
        '-I../Shared Files/mex source/Victoria_Park_models/','../Shared Files/mex source/predict.c',...
        '../Shared Files/mex source/Victoria_Park_models/models.c');

    fprintf('compiling sample.c\n')
    mex('-R2018a','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','-outdir','./compiled_mex',...
        '-I../Shared Files/mex source/Victoria_Park_models/','../Shared Files/mex source/sample.c',...
        '../Shared Files/mex source/Victoria_Park_models/models.c');

    fprintf('compiling update.c\n')
    mex('-R2018a','CXXFLAGS="$CXXFLAGS -std=c++17 -Wall"','-outdir','./compiled_mex',...
        '-I../Shared Files/mex source/Victoria_Park_models/','../Shared Files/mex source/update.c',...
        '../Shared Files/mex source/Victoria_Park_models/models.c');
