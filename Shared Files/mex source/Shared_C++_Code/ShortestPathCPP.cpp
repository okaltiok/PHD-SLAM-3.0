...
size_t kBest2D(const size_t k,const size_t numRow,const size_t numCol,const bool maximize,const double *C, ScratchSpace &workMem,ptrdiff_t *col4rowBest,ptrdiff_t *row4colBest,double *gainBest, double threshold) {
    size_t curSweep;
